import LikeButton from "../React/LikeButton.jsx";
...
const socialLinks = [
  ...
  {
    href: "https://mail.google.com/mail/?view=cm&fs=1&to=isharaudayamali220@gmail.com",
    label: "Email",
        ...
        <div className="flex flex-col lg:items-start items-center space-y-6 gap-9">
          <div className="flex space-x-6 sm:space-x-8">
            {socialLinks.map((link) => (
              ...
              >
                <div
                  className="text-[var(--white-icon)] hover:text-[var(--white)] transition duration-300 ease-in-out"
      ...
      <div className="mt-12 pt-8 border-t border-[#ffffff10]">
        <p className="text-center text-sm text-[var(--white-icon)] space-y-2">
          <span className="block sm:inline">
            Copyright © {new Date().getFullYear()} Ishara Udayamali. All rights
            reserved.
          </span>
        </p>
      </div>
